--Let's work with a view on AdventureWorks2016
USE [AdventureWorks2016]
GO

/****** Object:  View [Sales].[vSalesPerson]    Script Date: 30/10/2020 21:24:21 ******/
SET ANSI_NULLS ON
GO
...
--First example: Update the name of a Employee through the view
UPDATE [Sales].[vSalesPerson] SET FirstName = 'Michael' 
WHERE JobTitle = 'North American Sales Manager'

--Second example: Insert a new PhoneType through the view
